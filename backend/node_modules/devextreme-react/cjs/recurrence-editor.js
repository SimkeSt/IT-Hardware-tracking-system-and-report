...
const recurrence_editor_1 = __importDefault(require("devextreme/ui/recurrence_editor"));
const component_1 = require("./core/component");
const RecurrenceEditor = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: recurrence_editor_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
