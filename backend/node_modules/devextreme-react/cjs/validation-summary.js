...
const validation_summary_1 = __importDefault(require("devextreme/ui/validation_summary"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const ValidationSummary = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: validation_summary_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
