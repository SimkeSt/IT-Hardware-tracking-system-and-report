...
const CircularGauge = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: circular_gauge_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
