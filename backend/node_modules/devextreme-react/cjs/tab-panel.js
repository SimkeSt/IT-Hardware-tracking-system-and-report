...
const tab_panel_1 = __importDefault(require("devextreme/ui/tab_panel"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const TabPanel = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const subscribableOptions = (0, react_1.useMemo)(() => (["items", "selectedIndex", "selectedItem"]), []);
    const independentEvents = (0, react_1.useMemo)(() => (["onContentReady", "onDisposing", "onInitialized", "onItemClick", "onItemContextMenu", "onItemHold", "onItemRendered", "onSelectionChanging", "onTitleClick", "onTitleHold", "onTitleRendered"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: tab_panel_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
