...
const draggable_1 = __importDefault(require("devextreme/ui/draggable"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const Draggable = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onDisposing", "onDragEnd", "onDragMove", "onDragStart", "onInitialized"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: draggable_1.default,
        ref: baseRef,
        independentEvents,
        expectedChildren,
        templateProps,
