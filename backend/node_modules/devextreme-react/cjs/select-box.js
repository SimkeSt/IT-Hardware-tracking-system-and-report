...
const select_box_1 = __importDefault(require("devextreme/ui/select_box"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const SelectBox = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onChange", "onClosed", "onContentReady", "onCopy", "onCustomItemCreating", "onCut", "onDisposing", "onEnterKey", "onFocusIn", "onFocusOut", "onInitialized", "onInput", "onItemClick", "onKeyDown", "onKeyUp", "onOpened", "onPaste", "onValueChanged"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: select_box_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
