...
const tree_map_1 = __importDefault(require("devextreme/viz/tree_map"));
...
const _componentColorizer = (props) => {
    return React.createElement((nested_option_1.default), {
        ...props,
        elementDescriptor: {
...
exports.Group = Group;
const _componentGroupLabel = (props) => {
    return React.createElement((nested_option_1.default), {
        ...props,
        elementDescriptor: {
            OptionName: "label",
...
exports.Tile = Tile;
const _componentTileLabel = (props) => {
    return React.createElement((nested_option_1.default), {
        ...props,
        elementDescriptor: {
            OptionName: "label",
...
const _componentTreeMapborder = (props) => {
    return React.createElement((nested_option_1.default), {
        ...props,
        elementDescriptor: {
            OptionName: "border",
