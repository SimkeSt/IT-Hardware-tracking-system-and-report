...
const Sortable = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onAdd", "onDisposing", "onDragChange", "onDragEnd", "onDragMove", "onDragStart", "onInitialized", "onRemove", "onReorder"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: sortable_1.default,
        ref: baseRef,
        independentEvents,
        expectedChildren,
        templateProps,
