...
const number_box_1 = __importDefault(require("devextreme/ui/number_box"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const NumberBox = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onChange", "onContentReady", "onCopy", "onCut", "onDisposing", "onEnterKey", "onFocusIn", "onFocusOut", "onInitialized", "onInput", "onKeyDown", "onKeyUp", "onPaste", "onValueChanged"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: number_box_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
