...
const radio_group_1 = __importDefault(require("devextreme/ui/radio_group"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const RadioGroup = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: radio_group_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
