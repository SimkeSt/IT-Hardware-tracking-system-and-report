...
const check_box_1 = __importDefault(require("devextreme/ui/check_box"));
const component_1 = require("./core/component");
const CheckBox = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: check_box_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
