...
exports.To = exports.Position = exports.Offset = exports.My = exports.From = exports.Collision = exports.BoundaryOffset = exports.At = exports.Animation = exports.DeferRendering = void 0;
const React = __importStar(require("react"));
const react_1 = require("react");
const defer_rendering_1 = __importDefault(require("devextreme/ui/defer_rendering"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const DeferRendering = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onContentReady", "onDisposing", "onInitialized", "onRendered", "onShown"]), []);
    const expectedChildren = (0, react_1.useMemo)(() => ({
        animation: { optionName: "animation", isCollectionItem: false }
    }), []);
    return (React.createElement((component_1.Component), {
        WidgetClass: defer_rendering_1.default,
        ref: baseRef,
        independentEvents,
        expectedChildren,
        ...props,
