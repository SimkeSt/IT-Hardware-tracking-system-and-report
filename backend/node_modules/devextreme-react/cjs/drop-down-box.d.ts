...
import dxDropDownBox, { Properties } from "devextreme/ui/drop_down_box";
...
declare const DropDownBox: (props: React.PropsWithChildren<IDropDownBoxOptions> & {
    ref?: Ref<DropDownBoxRef>;
}) => ReactElement | null;
...
export { DropDownBox, IDropDownBoxOptions, DropDownBoxRef, Animation, IAnimationProps, At, IAtProps, BoundaryOffset, IBoundaryOffsetProps, Button, IButtonProps, Collision, ICollisionProps, DropDownOptions, IDropDownOptionsProps, From, IFromProps, Hide, IHideProps, My, IMyProps, Offset, IOffsetProps, Options, IOptionsProps, Position, IPositionProps, Show, IShowProps, To, IToProps, ToolbarItem, IToolbarItemProps };
