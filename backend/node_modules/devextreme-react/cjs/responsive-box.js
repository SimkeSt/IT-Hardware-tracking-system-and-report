...
const responsive_box_1 = __importDefault(require("devextreme/ui/responsive_box"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const ResponsiveBox = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: responsive_box_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
