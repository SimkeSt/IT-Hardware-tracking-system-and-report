...
const multi_view_1 = __importDefault(require("devextreme/ui/multi_view"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const MultiView = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const independentEvents = (0, react_1.useMemo)(() => (["onContentReady", "onDisposing", "onInitialized", "onItemClick", "onItemContextMenu", "onItemHold", "onItemRendered"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: multi_view_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
