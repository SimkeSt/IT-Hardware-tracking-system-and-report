...
const Component = (0, react_1.forwardRef)((props, ref) => {
    ...
    const renderChildren = (0, react_1.useCallback)(() => React.Children.map(props.children, (child) => {
        if (React.isValidElement(child) && (0, extension_component_1.elementIsExtension)(child)) {
