...
import dxSelectBox, { Properties } from "devextreme/ui/select_box";
...
type ISelectBoxOptionsNarrowedEvents = {
...
declare const SelectBox: (props: React.PropsWithChildren<ISelectBoxOptions> & {
...
export { SelectBox, ISelectBoxOptions, SelectBoxRef, Animation, IAnimationProps, At, IAtProps, BoundaryOffset, IBoundaryOffsetProps, Button, IButtonProps, Collision, ICollisionProps, DropDownOptions, IDropDownOptionsProps, From, IFromProps, Hide, IHideProps, Item, IItemProps, My, IMyProps, Offset, IOffsetProps, Options, IOptionsProps, Position, IPositionProps, Show, IShowProps, To, IToProps, ToolbarItem, IToolbarItemProps };
