...
const button_group_1 = __importDefault(require("devextreme/ui/button_group"));
const component_1 = require("./core/component");
const nested_option_1 = __importDefault(require("./core/nested-option"));
const ButtonGroup = (0, react_1.memo)((0, react_1.forwardRef)((props, ref) => {
    ...
    const subscribableOptions = (0, react_1.useMemo)(() => (["selectedItemKeys", "selectedItems"]), []);
    const independentEvents = (0, react_1.useMemo)(() => (["onContentReady", "onDisposing", "onInitialized", "onItemClick"]), []);
    ...
    return (React.createElement((component_1.Component), {
        WidgetClass: button_group_1.default,
        ref: baseRef,
        subscribableOptions,
        independentEvents,
        defaults,
